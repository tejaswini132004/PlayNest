...
const MESSAGES = [
  <>You have <span className="hi">5 games</span> waiting for you today! 🎮</>,
  ...
  <>New game alert! <span className="hi">Voice Recognition</span> has been updated! 🎤</>,
...
function HomePage() {
  ...
  // Rotate welcome messages every 3.5s
  useEffect(() => {
    ...
    <div className="home-page">
      ...
      <div className="hp-page">
        ...
        <div className="hp-card">
          ...
          <div className="hp-child-name">Arjun!</div>
